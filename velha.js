...
let contadorX, contadorO = 0;

let contadorJogadorX = document.getElementById('jogador-x');

let contadorJogadorO = document.getElementById('jogador-o');
...
function contador(){
    ...
    contadorJogadorX.innerHTML = contadorX;
    contadorJogadorO.innerHTML = contadorO;
}